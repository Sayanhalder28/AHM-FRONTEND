...
function AssetRegForm({ visible, handleClose }) {
  ...
  const formatDataToSend = () => {
    ...
    const formattedData = {
      ...
      asset_image: '', // You can add an image URL here if needed
  ...
  const handleSubmit = (e) => {
    ...
    fetch(`/data/asset/register-asset`, {
      method: 'POST',
      headers: {
    ...
    <section className='absolute inset-0 bg-slate-200 bg-opacity-20 backdrop-blur-sm z-50 h-full flex justify-center'>
      ...
      >
        ...
        <div className='flex items-center justify-center my-28'>
          <button
            type='submit'
            className='bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded focus:outline-none focus:ring focus:ring-blue-200 -mb-28 mt-20'
          >
            Submit
          </button>
        </div>
