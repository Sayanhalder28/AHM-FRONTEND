...
const Report = () => {
  ...
  const [assetDetails, setAssetDetails] = useState({
    ...
    vibration_y: 'Loading...',
    vibration_z: 'Loading...',
    vibration_peak: 'Loading...',
    magnetic_flux_x: 'Loading...',
    magnetic_flux_y: 'Loading...',
    magnetic_flux_z: 'Loading...',
    magnetic_flux_peak: 'Loading...',
    ultrasound: 'Loading...',
    ultrasound_delta: 'Loading...',
    ...
    <div className='px-4 md:px-10 pt-3'>
      <div className='flex flex-nowrap justify-between items-center'>
        ...
        <div className='flex gap-3'>
          <button onClick={handlePrint} className=' bg-green-700 px-7 w-min text-lg font-semibold'>
            Print
          </button>
        </div>
      </div>
        ...
        <div className='justify-items-center mx-4' ref={componentRef}>
          ...
          <div>
            <div className='py-7'>
              ...
              <h1 className='bg-sky-200 mr-96 px-4 mx-4 font-semibold'>Sensors Connected</h1>
              <div className=' w-full mx-auto p-4'>
                <table className='w-full border border-collapse border-gray-300'>
                  <tbody>
                    <tr className='bg-white'>
          ...
          <div>
            ...
            <footer className='text-center font-semibold py-4'>5.</footer>
          </div>
          ...
          <div>
            <div className='px-2 py-4'>
              ...
              <h2 className='font-semibold mx-4 mt-5'>Temperature Trend:</h2>
              <div className='w-full flex flex-col items-center'>
                <div className='w-fit h-fit border-2 border-current rounded-xl m-2 py-4 px-4 font-semibold'>
          ...
          <div>
            <div className='py-4 mx-2'>
              <h1 className='font-semibold text-lg bg-sky-200 px-4'>Past 24 hr Monitoring:</h1>
            ...
            <footer className='text-center font-semibold py-4'>7.</footer>
          </div>

          {/* eighth page */}
          <div>
            <div className='py-4'>
              <h1 className='font-semibold text-lg bg-sky-200 mx-2 px-4'>Glossary:</h1>
            ...
            <footer className='text-center font-semibold py-4'>8.</footer>
          </div>
        </div>
      </div>
    </div>
