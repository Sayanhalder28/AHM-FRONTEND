...
import UserICO from '../assets/iemathree.png';

export default function TopBar({ showNav, setShowNav }) {
  return (
    <div
      className={`fixed w-screen h-16 flex justify-between items-center transition-all duration-[400ms] border-t-4 border-t-teal-500 bg-white shadow-sm z-40 ${
        showNav ? 'pl-56' : ''
      }`}
    >
